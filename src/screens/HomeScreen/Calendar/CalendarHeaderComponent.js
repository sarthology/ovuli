...
class CalendarHeaderComponent extends React.PureComponent {
  ...
  render() {
    const month = moment(this.props.month.getTime())
      .format('MMMM')
      .toString();
    const year = moment(this.props.month.getTime()).format('YYYY');
    return (
      <View>
        <View style={styles.header}>
          <TouchableOpacity onPress={this.onPressArrowLeft}>
          ...
          <TouchableOpacity style={styles.iconContainer} onPress={this.onPressArrowRight}>
